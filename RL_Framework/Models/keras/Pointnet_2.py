...
def get_pointnet_model(last_layer_size: int, num_points: int, dim: int) -> keras.Model:
    ...
    pos = layers.Dense(3, name="pos_layer")(x)
    x = layers.Dense(16, "relu", name="dense_3")(pos)
    x = layers.Dense(16, "relu", name="dense_4")(x)
    x = layers.Dense(8, "relu", name="dense_5")(x)
    rot = layers.Dense(2, name="rot_layer")(x)
